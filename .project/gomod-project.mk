...
GOPACKAGES_FOR_TEST = $(shell go list ./... | grep -v /tests/ | grep -v /mocks/)
...
define go_test_cover
	...
	exitCode=0 \
	&& cd $(1) && go list $(5)/... | grep -v /tests/ | grep -v /mocks/ | ( while read -r pkg; do \
...
#
bench:
	go test  ${TEST_RACEFLAG} -bench . ${GOPACKAGES_FOR_TEST}
