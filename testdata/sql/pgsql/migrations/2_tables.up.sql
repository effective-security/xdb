...
INSERT INTO public.user (id, email, email_verified, name)
VALUES
    (1, 'user1@example.com', FALSE, 'User 1'),
    (2, 'user2@example.com', FALSE, 'User 2'),
    (3, 'user3@example.com', TRUE, 'User 3');

-- Populate the org table
INSERT INTO public.org (id, name, email, billing_email, company, street_address, city, postal_code, region, country, phone, quota, settings)
VALUES
...
INSERT INTO public.orgmember (id, org_id, user_id, role)
VALUES
    (1, 1, 1, 'Admin'),
    (2, 1, 2, 'Member'),
    (3, 2, 2, 'Admin'),
